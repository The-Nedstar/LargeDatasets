...
![Figure 1: Histogram showing the distribution of the population growth rate within the Aves Clade.](Figures/LHist.png)
...
![Figure 2: Histogram showing the distribution of the population growth rate within the Aves Clade.](Figures/GTHist.png)
...
![Figure 3: a scatterplot comparing growth rate to generation time in the Aves class.](Figures/GTvL.png)
...
![Figure 5: Boxplot showing the generation time of species in each conservation status category](Figures/IUCNvGT.png)
...
![Figure 6: Boxplot showing the population growth rate of species in each conservation status category](Figures/IUCNvL.png)
