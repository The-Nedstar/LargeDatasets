...
svglite(here("Figures", "PerfTree.svg"), width = 8,
          height = 8,
          scaling = 1.3)
dotTree(TreeNoLabels, PopPerf, colors=setNames(c("#EA0000", "#1E88E5"), c("Decrease","Increase")), ftype="i", xlim=c(0, 1.5 * max(nodeHeights(TreeNoLables))))

tiplabels(text=as.character(IUCNstatus), adj=c(-1, 0.2), frame="none", cex=0.6, col="black")
