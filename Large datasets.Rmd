...
-   analsysis of biological patterns in the aves class

    -   change the name of the class to try another class

    -   taxanomic subset

-   using various online tools

    -   Compadre for demographjic data

    -   RedList for endangement status

    -   open tree of life for phylogenetic data

-   investigating growth rate and generation time

    -   their relation with status and

    -   how this is all phylogenetically linked
