...
PerfTree <- dotTree(PrunedTree, PopPerf, colors=setNames(c("#EA0000", "#1E88E5"), c("Decrease","Increase")), ftype="i", fsize=0.6)

PerfTree <- tiplabels(text=as.character(IUCNstatus), adj=c(0.5, 0), frame="none", cex=0.6, col="black",)
```
