...
Due to issues with accessing the online database, instead we have imported the data relevant to the compadre database from a csv (also accessible on the github repository, under the folder "Data" [@the2025]).
...
svglite(here("Figures", "PrunedTree.svg"), width = 8, height = 8, scaling = 1.2) 
