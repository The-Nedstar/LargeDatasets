...
This Document also functions as a template for this analysis in any species, by changing the variable "class" to the name of the class (as used in the compadre database) you want to follow, and the code will run the same analysis on that data and change figures and figure titles accordingly. On [@the] anonomised github repository you can find all of the files used and a blank template containing the code without the specific analysis and write up for usage in your own analysis.
...
-   online database of demographic data

    -   their species identification and taxonomy

    -   geographic data

    -   data bout their life histories

    -   collected from global archived studies

-   matrix population models

-   useful for ecologogists, evolutionary biologists and conservationists
...
![](Figures/Diagnostic%20plots.png)
